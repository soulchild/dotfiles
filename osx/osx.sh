...
# Based on the awesome os x dotfile by https://github.com/mathiasbynens/dotfiles.
...
for app in "Activity Monitor" "Address Book" "Calendar" "Contacts" "cfprefsd" \
	"Dock" "Finder" "Google Chrome" "Mail" "Messages" "Safari" "SystemUIServer"; do
